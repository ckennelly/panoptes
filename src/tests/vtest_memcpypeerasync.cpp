...
TEST(MemcpyPeerAsync, InvalidDevices) {
    cudaError_t ret;
    cudaStream_t stream;
    int devices;
    ...
    ret = cudaMemcpyPeerAsync(NULL, devices, NULL, devices, 0, stream);
    EXPECT_EQ(cudaSuccess, ret);

    ret = cudaMemcpyPeerAsync(NULL, devices, NULL, devices, 4, stream);
...
TEST(MemcpyPeerAsync, OutOfBounds) {
    cudaError_t ret;
    cudaStream_t stream;
    int devices;
    ...
    ret = cudaMemcpyPeerAsync(NULL, 0, NULL, 0, 0, stream);
    EXPECT_EQ(cudaSuccess, ret);

    ret = cudaMemcpyPeerAsync(NULL, 0, NULL, 0, 4, stream);
    ...
    ret = cudaMemcpyPeerAsync(d0, 0, d0, 0, 2 * size, stream);
    EXPECT_EQ(cudaErrorInvalidValue, ret);
    ...
    ret = cudaMemcpyPeerAsync(NULL, 0, NULL, 1, 0, stream);
    EXPECT_EQ(cudaSuccess, ret);

    ret = cudaMemcpyPeerAsync(NULL, 0, NULL, 1, 4, stream);
    EXPECT_EQ(cudaErrorInvalidValue, ret);
    ...
    ret = cudaMemcpyPeerAsync(d0, 0, d1, 1, 2 * size, stream);
    EXPECT_EQ(cudaErrorInvalidValue, ret);
...
TEST(MemcpyPeerAsync, Basic) {
    ...
    ret = cudaMemcpyPeerAsync(d0 + 2, 0, d0, 0, size, stream);
    EXPECT_EQ(cudaSuccess, ret);
    ...
    ret = cudaMemcpyPeerAsync(d1, 1, d0, 0, size, stream);
    EXPECT_EQ(cudaSuccess, ret);
