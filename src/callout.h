...
public:
    static void         cudaRegisterFunction(void **,
        const char *, char *, const char *, int, uint3 *, uint3 *, dim3 *,
        dim3 *, int *);
    ...
    static cudaError_t cudaBindTexture2D(size_t *offset, const struct
            textureReference *texref, const void *devPtr, const struct
            cudaChannelFormatDesc *desc, size_t width, size_t height, size_t
            pitch);
    static cudaError_t cudaBindTextureToArray(const struct textureReference *texref,
            const struct cudaArray *array, const struct
            cudaChannelFormatDesc *desc);
    static cudaError_t cudaChooseDevice(int *device, const struct cudaDeviceProp *prop);
    static cudaError_t cudaConfigureCall(dim3 gridDim, dim3 blockDim,
            size_t sharedMem, cudaStream_t stream);
    static cudaChannelFormatDesc cudaCreateChannelDesc(int x, int y, int z, int w, enum
    ...
    static cudaError_t cudaDeviceGetCacheConfig(enum cudaFuncCache *pCacheConfig);
    static cudaError_t cudaDeviceGetLimit(size_t *pValue, enum cudaLimit limit);
    static cudaError_t cudaDeviceGetPCIBusId(char *pciBusId, int len,
        int device);
    static cudaError_t cudaDeviceSetCacheConfig(enum cudaFuncCache cacheConfig);
    ...
    static cudaError_t cudaEventCreateWithFlags(cudaEvent_t *event, unsigned int flags);
    ...
    static cudaError_t cudaFuncGetAttributes(struct cudaFuncAttributes *attr, const
            char *func);
    static cudaError_t cudaFuncSetCacheConfig(const char *func, enum cudaFuncCache
            cacheConfig);
    static cudaError_t cudaGetChannelDesc(struct cudaChannelFormatDesc *desc, const
            struct cudaArray *array);
    static cudaError_t cudaGetDevice(int *device);
    static cudaError_t cudaGetDeviceCount(int *count);
    static cudaError_t cudaGetDeviceProperties(struct cudaDeviceProp *prop, int device);
    const char * cudaGetErrorString(cudaError_t error);
    static cudaError_t cudaGetExportTable(const void **ppExportTable, const cudaUUID_t
            *pExportTableId);
    static cudaError_t cudaGetLastError(void);
    static cudaError_t cudaGetSurfaceReference(const struct surfaceReference **surfRef,
            const char *symbol);
    ...
    static cudaError_t cudaGetTextureAlignmentOffset(size_t *offset, const struct
            textureReference *texref);
    static cudaError_t cudaGetTextureReference(const struct textureReference **texref,
            const char *symbol);
    static cudaError_t cudaGraphicsMapResources(int count, cudaGraphicsResource_t
            *resources, cudaStream_t stream);
    static cudaError_t cudaGraphicsResourceGetMappedPointer(void **devPtr, size_t *size,
            cudaGraphicsResource_t resource);
    static cudaError_t cudaGraphicsResourceSetMapFlags(cudaGraphicsResource_t resource,
            unsigned int flags);
    static cudaError_t cudaGraphicsSubResourceGetMappedArray(struct cudaArray **array,
            cudaGraphicsResource_t resource, unsigned int arrayIndex, unsigned int
            mipLevel);
    static cudaError_t cudaGraphicsUnmapResources(int count, cudaGraphicsResource_t
            *resources, cudaStream_t stream);
    ...
    static cudaError_t cudaHostGetDevicePointer(void **pDevice, void *pHost, unsigned int flags);
    static cudaError_t cudaHostGetFlags(unsigned int *pFlags, void *pHost);
    static cudaError_t cudaHostRegister(void *ptr, size_t size, unsigned int flags);
    ...
    static cudaError_t cudaIpcGetMemHandle(cudaIpcMemHandle_t *handle, void *devPtr);
    static cudaError_t cudaIpcOpenMemHandle(void **devPtr, cudaIpcMemHandle_t handle,
            unsigned int flags);
    static cudaError_t cudaIpcCloseMemHandle(void *devPtr);
    static cudaError_t cudaMalloc(void **devPtr, size_t size);
    static cudaError_t cudaMalloc3D(struct cudaPitchedPtr *pitchedDevPtr, struct
            cudaExtent extent);
    static cudaError_t cudaMalloc3DArray(struct cudaArray** array, const struct
            cudaChannelFormatDesc *desc, struct cudaExtent extent, unsigned int
            flags);
    static cudaError_t cudaMallocArray(struct cudaArray **array, const struct
            cudaChannelFormatDesc *desc, size_t width, size_t height, unsigned int
            flags);
    static cudaError_t cudaMallocHost(void **ptr, size_t size);
    static cudaError_t cudaMallocPitch(void **devPtr, size_t *pitch, size_t width, size_t height);
    static cudaError_t cudaMemcpy(void *dst, const void *src, size_t size, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpy2D(void *dst, size_t dpitch, const void *src, size_t
            pitch, size_t width, size_t height, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpy2DAsync(void *dst, size_t dpitch, const void *src,
            size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind,
            cudaStream_t stream);
    static cudaError_t cudaMemcpy2DArrayToArray(struct cudaArray *dst, size_t wOffsetDst,
            ...
            kind);
    static cudaError_t cudaMemcpy2DFromArray(void *dst, size_t dpitch, const struct
            cudaArray *src, size_t wOffset, size_t hOffset, size_t width, size_t
            height, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpy2DFromArrayAsync(void *dst, size_t dpitch, const struct
            cudaArray *src, size_t wOffset, size_t hOffset, size_t width, size_t
            height, enum cudaMemcpyKind kind, cudaStream_t stream);
    static cudaError_t cudaMemcpy2DToArray(struct cudaArray *dst, size_t wOffset,
            size_t hOffset, const void *src, size_t spitch, size_t width, size_t
            height, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpy2DToArrayAsync(struct cudaArray *dst, size_t wOffset,
            size_t hOFfset, const void *src, size_t spitch, size_t width, size_t
            height, enum cudaMemcpyKind kind, cudaStream_t stream);
    ...
    static cudaError_t cudaMemcpyArrayToArray(struct cudaArray *dst, size_t wOffsetDst,
            size_t hOffsetDst, const struct cudaArray *src, size_t wOffsetSrc,
            size_t hOffsetSrc, size_t count, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpyAsync(void *dst, const void *src, size_t count,
            enum cudaMemcpyKind kind, cudaStream_t stream);
    static cudaError_t cudaMemcpyFromArray(void *dst, const struct cudaArray *src,
            size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpyFromArrayAsync(void *dst, const struct cudaArray *src,
            size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind,
            cudaStream_t stream);
    static cudaError_t cudaMemcpyFromSymbol(void *dst, const char *symbol, size_t count,
            size_t offset, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpyFromSymbolAsync(void *dst, const char *symbol, size_t
    ...
    static cudaError_t cudaMemcpyToArray(struct cudaArray *dst, size_t wOffset, size_t
            hOffset, const void *src, size_t count, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpyToArrayAsync(struct cudaArray *dst, size_t wOffset,
            size_t hOffset, const void *src, size_t count, enum cudaMemcpyKind
            kind, cudaStream_t stream);
    static cudaError_t cudaMemcpyToSymbol(const char *symbol, const void *src, size_t
            count, size_t offset, enum cudaMemcpyKind kind);
    static cudaError_t cudaMemcpyToSymbolAsync(const char *symbol, const void *src,
    ...
    static cudaError_t cudaMemset2D(void *devPtr, size_t pitch, int value, size_t
            width, size_t height);
    static cudaError_t cudaMemset2DAsync(void *devPtr, size_t pitch, int value, size_t
            width, size_t height, cudaStream_t stream);
    static cudaError_t cudaMemset3D(struct cudaPitchedPtr pitchedDevPtr, int value,
            struct cudaExtent extent);
    static cudaError_t cudaMemset3DAsync(struct cudaPitchedPtr pitchedDevPtr, int value,
    ...
    static cudaError_t cudaPointerGetAttributes(struct cudaPointerAttributes *attributes,
        void *ptr);
    ...
    static cudaError_t cudaSetupArgument(const void *arg, size_t size, size_t offset);
    ...
    static cudaError_t cudaStreamWaitEvent(cudaStream_t stream, cudaEvent_t event,
            unsigned int flags);
    static cudaError_t cudaThreadExit(void);
    static cudaError_t cudaThreadGetCacheConfig(enum cudaFuncCache *pCacheConfig);
    static cudaError_t cudaThreadGetLimit(size_t *pValue, enum cudaLimit limit);
    static cudaError_t cudaThreadSetCacheConfig(enum cudaFuncCache cacheConfig);
    static cudaError_t cudaThreadSetLimit(enum cudaLimit limit, size_t value);
    static cudaError_t cudaThreadSynchronize();
    static cudaError_t cudaUnbindTexture(const struct textureReference *texref);
